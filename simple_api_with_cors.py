#!/usr/bin/env python3
"""
Simple API for the chatbot with CORS support
"""
...
if __name__ == "__main__":
    print("Starting chatbot API with CORS support...")
    print("API will be available at: http://localhost:8001")
    print("You can now open simple_chat.html in your browser")
    uvicorn.run("simple_api_with_cors:app", host="0.0.0.0", port=8001, reload=True)